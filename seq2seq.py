...
def plotMSE(results, title):
    ...
    evolution = sorted([[results[i]['future'], results[i]['test_loss']] for i in results], key=lambda d: d[0])
    x = [d[0] for d in evolution]
    y = [d[1] for d in evolution]
